...
- Name: user\profile.spec.ts >> USER Profile Flow >> Access /dashboard/profile - loads correctly
- Location: tests\user\profile.spec.ts:16:7
...
Locator: locator('h1:has-text("Meu Perfil")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1:has-text("Meu Perfil")')
