...
- Name: admin\users-edit.spec.ts >> ADMIN Edit User >> Edit user - non-existent user
- Location: tests\admin\users-edit.spec.ts:62:7
...
Locator: locator('text=Usuário não encontrado')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Usuário não encontrado')
