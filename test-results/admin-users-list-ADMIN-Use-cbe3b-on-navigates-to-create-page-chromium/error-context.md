...
- Name: admin\users-list.spec.ts >> ADMIN Users List >> Create new user button navigates to create page
- Location: tests\admin\users-list.spec.ts:32:7
...
Call log:
  - waiting for locator('text=+ Novo usuário')
