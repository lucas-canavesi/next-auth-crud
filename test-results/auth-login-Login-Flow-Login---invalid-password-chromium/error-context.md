...
- Name: auth\login.spec.ts >> Login Flow >> Login - invalid password
- Location: tests\auth\login.spec.ts:60:7
...
Locator: locator('text=Email ou senha inválidos')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Email ou senha inválidos')
