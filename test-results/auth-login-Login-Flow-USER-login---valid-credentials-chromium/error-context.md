...
- Name: auth\login.spec.ts >> Login Flow >> USER login - valid credentials
...
Locator: locator('text=Joao Admin Atualizado')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Joao Admin Atualizado')
