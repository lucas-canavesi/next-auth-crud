...
- Name: auth\route-protection.spec.ts >> Route Protection - Unauthenticated User >> Access /dashboard/profile without login redirects to /login
- Location: tests\auth\route-protection.spec.ts:23:7
...
Received: "http://localhost:3000/dashboard/profile"
Timeout:  5000ms
...
Call log:
  - Expect "toHaveURL" with timeout 5000ms
    14 × locator resolved to <html lang="pt-BR" class="geist_a71539c9-module__T19VSG__variable geist_mono_8d43a2aa-module__8Li5zG__variable h-full antialiased">…</html>
       - unexpected value "http://localhost:3000/dashboard/profile"
